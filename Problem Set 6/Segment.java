...
public class Segment implements Shape {
	...
	/**
	 * Complete segment from one point to the other, but with parameters passed as list of Strings
	 * @param args		list of params
	 */
	public Segment(String[] args) {
		this.x1 = Integer.parseInt(args[0]); this.y1 = Integer.parseInt(args[1]);
		this.x2 = Integer.parseInt(args[2]); this.y2 = Integer.parseInt(args[3]);
